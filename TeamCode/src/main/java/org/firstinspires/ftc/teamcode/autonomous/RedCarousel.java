...
@Autonomous(name = "RedCarousel", group = "Red Carousel")
    ...
    public void runOpMode() {
      ...
      /*  traj2Top = drive.trajectoryBuilder(traj1.end())
        ...
        traj4 = drive.trajectorySequenceBuilder(traj1.end())
                .lineToLinearHeading(new Pose2d(-58, -53, Math.toRadians(220)),
        ...
        traj8Top = drive.trajectorySequenceBuilder(traj7.end())
                ...
                .lineToLinearHeading(new Pose2d( -41.2, -21, Math.toRadians(180)))
                .build();

        traj8Mid = drive.trajectorySequenceBuilder(traj7.end())
                .turn(-Math.toRadians(90))
                .lineToLinearHeading(new Pose2d( -36, -21, Math.toRadians(180)))
                .build();

        traj8Low = drive.trajectorySequenceBuilder(traj7.end())
                .turn(-Math.toRadians(90))
                .lineToLinearHeading(new Pose2d( -35, -21, Math.toRadians(180)))
                .build();
        ...
        traj9Low = drive.trajectorySequenceBuilder(traj8Low.end())
                .lineToLinearHeading(new Pose2d(-53, -15, Math.toRadians(180)))
                .turn(Math.toRadians(180))
                .build();

        traj10 = drive.trajectorySequenceBuilder(traj9Low.end())
                .lineToLinearHeading(new Pose2d(-64, -36, Math.toRadians(360)))
                .back(5)
                .build();
