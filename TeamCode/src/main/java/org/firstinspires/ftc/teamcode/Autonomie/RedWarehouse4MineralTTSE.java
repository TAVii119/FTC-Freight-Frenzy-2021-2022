...
@Autonomous(name = "RedWarehouse4MineralTTSE")
public class RedWarehouse4MineralTTSE extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        webcam = new BarcodeUtil(hardwareMap, "Webcam 1", telemetry, 3);
        webcam.init();
