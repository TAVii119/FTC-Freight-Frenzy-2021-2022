 ...
 */
@Disabled
public class ReLocalizeTest extends CommandBase {
     ...
     */
    public ReLocalizeTest(Consumer<Pose2d> poseConsumer, DistanceSensors distanceSensors, DoubleSupplier headingSupplier, boolean redSide) {
        super();
