...
@Disabled
@TeleOp(name="RedTeleOpSharedManual", group = "Manual Red")

public class RedTeleOpSharedManual extends CommandOpMode {
    ...
    private InstantCommand SharedPose2Command;
    ...
    public Thread levelSharedThread;
    ...
    public void initialize() {
        ...
        SharedPose2Command = new InstantCommand(() -> {
            if(!Pose2)
            Pose2 = true;
            else
                Pose2 = false;
        ...
        Button SwitchShared = new GamepadButton(driver1, GamepadKeys.Button.DPAD_UP).whenPressed(SharedPose2Command);

        // Scoring Command Threads
        Button useSlideButton = new GamepadButton(driver1, GamepadKeys.Button.RIGHT_BUMPER).whenPressed(() -> levelSharedThread.start());
