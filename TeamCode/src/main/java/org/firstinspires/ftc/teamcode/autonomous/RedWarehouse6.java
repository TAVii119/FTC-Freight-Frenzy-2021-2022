...
@Autonomous(name = "RedWarehouse6", group = "Red Warehouse")
public class RedWarehouse6 extends LinearOpMode {
    ...
    private double fourBarMidPos = 0.72;
    ...
    public void runOpMode() {
        ...
        traj2Top = drive.trajectoryBuilder(traj1.end())
                .lineToLinearHeading(new Pose2d(-5, -43, Math.toRadians(290)),
        ...
        traj2Mid = drive.trajectoryBuilder(traj1.end())
                .lineToLinearHeading(new Pose2d(1, -37, Math.toRadians(302)),
                        SampleMecanumDrive.getVelocityConstraint(65, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL)
                )
                .build();
        ...
        traj2Low = drive.trajectoryBuilder(traj1.end())
                .lineToLinearHeading(new Pose2d(-7, -37, Math.toRadians(292)),
                        SampleMecanumDrive.getVelocityConstraint(30, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL)
                )
                .build();

        traj3 = drive.trajectoryBuilder(traj2Top.end())
        ...
        traj4 = drive.trajectoryBuilder(traj3.end())
                .splineToLinearHeading(new Pose2d(41, -59), Math.toRadians(360))
                .build();

        traj5 = drive.trajectoryBuilder(traj4.end())
                .lineToLinearHeading(new Pose2d(46, -58.5, Math.toRadians(360)),
        ...
        traj7 = drive.trajectorySequenceBuilder(traj6.end())
                .setReversed(true)
                .splineTo(new Vector2d(5, -34), Math.toRadians(117),
                        SampleMecanumDrive.getVelocityConstraint(65, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL)
                )
                .build();
        ...
        traj8 = drive.trajectorySequenceBuilder(traj7.end())
                .setReversed(false)
                .splineToSplineHeading(new Pose2d(17, -58, Math.toRadians(360)), Math.toRadians(360),
                        SampleMecanumDrive.getVelocityConstraint(60, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL)
                )
                .build();
        ...
        traj9 = drive.trajectoryBuilder(traj8.end())
                .splineToLinearHeading(new Pose2d(44, -58.5), Math.toRadians(360))
                .build();

        traj10 = drive.trajectoryBuilder(traj9.end())
                .lineToLinearHeading(new Pose2d(48, -57, Math.toRadians(360)),
                        SampleMecanumDrive.getVelocityConstraint(15, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL)
                )
                .build();

        traj11 = drive.trajectoryBuilder(traj9.end())
                .lineToLinearHeading(new Pose2d(35, -59.5, Math.toRadians(360)))
                .build();

        traj12 = drive.trajectorySequenceBuilder(traj11.end())
                .setReversed(true)
                .splineTo(new Vector2d(5, -33.5), Math.toRadians(114),
                        SampleMecanumDrive.getVelocityConstraint(65, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL)
                )
                .build();
        ...
        traj15 = drive.trajectoryBuilder(traj13.end())
                .splineToLinearHeading(new Pose2d(46, -59), Math.toRadians(360))
                .build();

        traj16 = drive.trajectoryBuilder(traj15.end())
                .lineToLinearHeading(new Pose2d(50, -55, Math.toRadians(380)),
                        SampleMecanumDrive.getVelocityConstraint(15, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL)
                )
                .build();

        traj17 = drive.trajectoryBuilder(traj13.end())
                .lineToLinearHeading(new Pose2d(35, -59, Math.toRadians(360)))
                .build();

        traj18 = drive.trajectorySequenceBuilder(traj17.end())
                .setReversed(true)
                .splineTo(new Vector2d(2, -34.5), Math.toRadians(113),
                        SampleMecanumDrive.getVelocityConstraint(65, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL)
                )
                .build();
        ...
        traj19 = drive.trajectorySequenceBuilder(traj18.end())
                .setReversed(false)
                .splineToSplineHeading(new Pose2d( 18, -58, Math.toRadians(360)), Math.toRadians(360),
                        SampleMecanumDrive.getVelocityConstraint(60, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL)
                )
                .build();
        ...
        traj20 = drive.trajectoryBuilder(traj19.end())
                .splineToLinearHeading(new Pose2d(48, -58.5, Math.toRadians(385)), -Math.toRadians(360))
                .build();

        traj21 = drive.trajectoryBuilder(traj20.end())
                .lineToLinearHeading(new Pose2d(53, -54, Math.toRadians(385)),
                        SampleMecanumDrive.getVelocityConstraint(15, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL)
                )
                .build();

        traj22 = drive.trajectoryBuilder(traj19.end())
                .lineToLinearHeading(new Pose2d(35, -59, Math.toRadians(360)))
                .build();

        traj23 = drive.trajectorySequenceBuilder(traj22.end())
                .setReversed(true)
                .splineTo(new Vector2d(2, -33.5), Math.toRadians(107),
                        SampleMecanumDrive.getVelocityConstraint(65, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL)
                )
                .build();
        ...
        traj25 = drive.trajectoryBuilder(traj24.end())
                .splineToLinearHeading(new Pose2d(49, -58, Math.toRadians(380)), -Math.toRadians(360))
                .build();
        ...
        traj28 = drive.trajectorySequenceBuilder(traj4.end())
                .setReversed(true)
                .lineToLinearHeading(new Pose2d(35, -59, Math.toRadians(360)))
                .splineTo(new Vector2d(2, -34.2), Math.toRadians(113),
                        SampleMecanumDrive.getVelocityConstraint(65, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL)
                )
        ...
        traj29 = drive.trajectorySequenceBuilder(traj28.end())
                .setReversed(false)
                .splineToSplineHeading(new Pose2d(18, -58, Math.toRadians(360)), Math.toRadians(360),
                        SampleMecanumDrive.getVelocityConstraint(60, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL)
                )
                .splineToLinearHeading(new Pose2d(45, -58, Math.toRadians(360)), -Math.toRadians(360))
                .build();
        ...
        /*fifthCycleWareEntry = drive.trajectorySequenceBuilder(fourthCycleScore.end())
                ...
                .splineToLinearHeading(new Pose2d(50, -58, Math.toRadians(380)), -Math.toRadians(360))
                .build();*/
    ...
    private void CaseC(SampleMecanumDrive drive) {
        ...
        if(!isStopRequested())
            scoreThread.start();
        drive.followTrajectorySequence(traj29);
    }
