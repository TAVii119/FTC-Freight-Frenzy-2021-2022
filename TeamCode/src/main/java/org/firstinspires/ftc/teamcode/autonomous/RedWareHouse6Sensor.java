...
@Autonomous(name = "RedWareHouse6Sensor", group = "Red Warehouse")
public class RedWareHouse6Sensor extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        traj2Mid = drive.trajectoryBuilder(traj1.end())
                .lineToLinearHeading(new Pose2d(-5, -43.5, Math.toRadians(297)),
        ...
        traj2Low = drive.trajectoryBuilder(traj1.end())
                .lineToLinearHeading(new Pose2d(-7, -41, Math.toRadians(292)),
        ...
        traj4 = drive.trajectoryBuilder(traj3Low.end())
                .splineToLinearHeading(new Pose2d(44, -64), Math.toRadians(360))
                .build();

        traj5 = drive.trajectoryBuilder(traj4.end())
                .lineToLinearHeading(new Pose2d(50, -64, Math.toRadians(360)),
        ...
        traj9 = drive.trajectoryBuilder(traj8.end())
                .splineToLinearHeading(new Pose2d(46, -64), -Math.toRadians(360))
                .build();

        traj10 = drive.trajectoryBuilder(traj9.end())
                .lineToLinearHeading(new Pose2d(52, -63, -Math.toRadians(350)),
                        SampleMecanumDrive.getVelocityConstraint(15, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL)
                )
                .build();
        ...
        traj15 = drive.trajectoryBuilder(traj13.end())
                .splineToLinearHeading(new Pose2d(49, -64), Math.toRadians(360))
                .build();
        ...
        traj20 = drive.trajectoryBuilder(traj19.end())
                .splineToLinearHeading(new Pose2d(51, -64, Math.toRadians(380)), Math.toRadians(360))
                .build();
        ...
        traj25 = drive.trajectoryBuilder(traj24.end())
                .splineToLinearHeading(new Pose2d(53, -64, Math.toRadians(370)), Math.toRadians(360))
                .build();

        traj26 = drive.trajectorySequenceBuilder(traj25.end())
                .lineToLinearHeading(new Pose2d(59, -60, Math.toRadians(380)),
                        SampleMecanumDrive.getVelocityConstraint(15, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL)
                )
                .build();
    ...
    private void CaseC(SampleMecanumDrive drive) {
        ...
        if(distanceSensorRight.getDistance(DistanceUnit.INCH) <= 80) {
            drive.update();
