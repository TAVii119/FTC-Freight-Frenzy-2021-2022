...
public class TeleOperated extends CommandOpMode {
    ...
    private InstantCommand useCarouselCommand;
    ...
    public void initialize() {
        ...
        useCarouselCommand = new InstantCommand(() -> {
            if(carouselSubsystem.duckLeftServo.getPower() > 0.0) {
        ...
        Button depositPushButton = new GamepadButton(driver1, GamepadKeys.Button.LEFT_BUMPER).whenPressed(pushDepositCommand);
        ...
        Button levelMidButton = new GamepadButton(driver1, GamepadKeys.Button.DPAD_LEFT).whenPressed(levelMidFourBarCommand);
        Button levelTopButton = new GamepadButton(driver1, GamepadKeys.Button.DPAD_UP).whenPressed(levelTopFourBarCommand);
        Button useCarouselButton = new GamepadButton(driver1, GamepadKeys.Button.A).whenPressed(useCarouselCommand);
        Button dropIntakeButton = new GamepadButton(driver1, GamepadKeys.Button.B).whenPressed(dropIntakeCommand);
