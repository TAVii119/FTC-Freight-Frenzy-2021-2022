...
@Disabled
@Autonomous(name = "RedWarehouse3Info1")
public class RedWarehouse3Info1 extends LinearOpMode {
    ...
    private void CaseC() {
        ...
        traj3 = drive.trajectorySequenceBuilder(traj2.end())
                ...
                .lineToLinearHeading(new Pose2d(56, -57, Math.toRadians(360)))
                .addDisplacementMarker(() -> {
                    slideTopThread.start();
                })
                .lineToLinearHeading(new Pose2d(14, -57, Math.toRadians(360)))
    ...
    private void CaseA() {
        ...
        traj1 = drive.trajectorySequenceBuilder(traj0.end())
                .lineToLinearHeading(new Pose2d(-10, -44.55, Math.toRadians(290)))
