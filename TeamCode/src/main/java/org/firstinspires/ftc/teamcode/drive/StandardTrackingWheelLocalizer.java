...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double X_MULTIPLIER = 1.01066965; // Multiplier in the X direction
    public static double Y_MULTIPLIER = 1.15046643; // Multiplier in the Y direction

    public static double LATERAL_DISTANCE = 5.89; // in; distance between the left and right wheels
